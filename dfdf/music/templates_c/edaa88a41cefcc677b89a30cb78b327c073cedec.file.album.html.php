<?php /* Smarty version Smarty3-b8, created on 2012-02-29 01:49:51
         compiled from "/home/libmill/domains/lovemusic.cc/public_html/templates/template/gray/album.html" */ ?>
<?php /*%%SmartyHeaderCode:14695977194f4d13bf178973-74503053%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'edaa88a41cefcc677b89a30cb78b327c073cedec' => 
    array (
      0 => '/home/libmill/domains/lovemusic.cc/public_html/templates/template/gray/album.html',
      1 => 1330451123,
    ),
  ),
  'nocache_hash' => '14695977194f4d13bf178973-74503053',
  'function' => 
  array (
  ),
...
if (!is_callable('smarty_modifier_strip_tags')) include '/home/libmill/domains/lovemusic.cc/public_html/lib/Smarty/plugins/modifier.strip_tags.php';
if (!is_callable('smarty_modifier_strip')) include '/home/libmill/domains/lovemusic.cc/public_html/lib/Smarty/plugins/modifier.strip.php';
...
if (!is_callable('smarty_modifier_stripslashes')) include '/home/libmill/domains/lovemusic.cc/public_html/lib/Smarty/plugins/modifier.stripslashes.php';
...
templates/template/gray/images/search.png" width="24" height="24" id="search_submit"/>
  ...
  <div class="top">
    <ul>
      <a href="http://lovemovie.cc" target="_blank" title="视频点播">
      <li class="vod_out" onmouseout="this.className='vod_out'" onmouseover="this.className='vod_on'"></li>
      </a> <a href="http://dh.gcu.edu.cn" target="_blank" title="校内导航">
      <li class="dh_out" onmouseout="this.className='dh_out'" onmouseover="this.className='dh_on'"></li>
      </a> <a href="http://lib.gcu.edu.cn" target="_blank" title="图书馆">
      <li class="lib_out" onmouseout="this.className='lib_out'" onmouseover="this.className='lib_on'"></li>
      </a> <a href="http://www.gcu.edu.cn" target="_blank" title="学院主页">
      <li class="gzauto_out" onmouseout="this.className='gzauto_out'" onmouseover="this.className='gzauto_on'"></li>
      </a>
    </ul>
  </div>
</div>
...
?skin=gray" title="网站首页">
    <li class="index_out" onmouseout="this.className='index_out'" onmouseover="this.className='index_on'"></li>
    </a> <a href="<?php echo $_smarty_tpl->getVariable('base_url')->value;?>
radio.php?skin=gray" title="音乐电台" target="_blank">
    <li class="radio_out" onmouseout="this.className='radio_out'" onmouseover="this.className='radio_on'"></li>
    </a> <a href="<?php echo $_smarty_tpl->getVariable('base_url')->value;?>
resources.php?skin=gray&action=all" title="本站资源">
    <li class="resources_out" onmouseout="this.className='resources_out'" onmouseover="this.className='resources_on'"></li>
    </a> <a href="<?php echo $_smarty_tpl->getVariable('base_url')->value;?>
musician.php?skin=gray&action=all" title="音乐人介绍">
    <li class="musician_out" onmouseout="this.className='musician_out'" onmouseover="this.className='musician_on'"></li>
    </a> <a href="<?php echo $_smarty_tpl->getVariable('base_url')->value;?>
introduce.php?skin=gray&action=all" title="音乐推荐文章">
    <li class="introduce_out" onmouseout="this.className='introduce_out'" onmouseover="this.className='introduce_on'"></li>
    </a>
  </ul>
  <!--登录部分-->
  <div class="login">
    <ul>
      <li><a href="#" title="亲！你还没有somethingmusic的帐号吗？赶快注册一个吧！">注册</a> <a href="#" title="使用本站帐号登录">登录</a> <a href="<?php echo $_smarty_tpl->getVariable('base_url')->value;?>
qq/?skin=gray" title="使用QQ帐号登录"><img src="<?php echo $_smarty_tpl->getVariable('base_url')->value;?>
templates/template/gray/images/qq.png" border="0" align="top"/></a> <a href="<?php echo $_smarty_tpl->getVariable('base_url')->value;?>
...
?>
      <li jplayer="<?php echo $_smarty_tpl->getVariable('base_url')->value;?>
1.mp3" id="<?php echo $_smarty_tpl->getVariable('m')->value['id'];?>
"> 
