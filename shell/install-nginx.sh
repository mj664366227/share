...
yum -y install gcc libc6-dev gcc-c++ pcre-devel perl-devel perl-ExtUtils-Embed libgd2-xpm gd-devel libxml2 libxml2-dev libgd2-xpm-dev geoip-database libgeoip-dev make libxslt-dev rsync lrzsz
