...
public class ApiDoc {
	...
	private String parseResponseObject(Object obj) {
		...
		json=json.replaceAll("\".*\"", "\"<span class=\"sh_string\">\\$1</span>\"").trim();
		html.append(json);
		return html.toString();
	}
