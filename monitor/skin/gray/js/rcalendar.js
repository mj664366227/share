...
function rcalendar(text, mode, retfunction) { //文本域对象, 模式(dateonly,full), 选择日期后的事件函数(函数是新时间的Date对象)
	...
	if (!div_rcalendar) { //如果不存在，则初始化创建它
		...
		if (document.compatMode == "BackCompat" && navigator.userAgent.indexOf("MSIE") != -1) {
			css += "#rcalendar {width:200px; height:200px; background:#FFFFFF; border:1px solid #999999; padding:4px; overflow:hidden; font-size:12px;}";
			css += "#rcalendar * {font-family:'微软雅黑'; font-size:12px;}";
			...
			css += "#rhour {padding:0px 2px 0px 2px; background:#E9E9E9; cursor:pointer;}";
			css += "#rminute {padding:0px 2px 0px 2px; background:#E9E9E9; cursor:pointer;}";
			css += "#rsecond {padding:0px 2px 0px 2px; background:#E9E9E9; cursor:pointer;}";
			css += "#rbtns {width:90px; margin-left:10px; height:13px; float:right; text-align:right; overflow:hidden; font-size:11px;}";
			css += "#rhours {width:190px; height:108px;}";
			css += ".rhour {padding:3px 2px 3px 2px; background:#B0B0B0; color:#FFFFFF; height:18px;  float:left; cursor:pointer;}";
			css += "#rminutes {width:190px; height:200px;}";
			css += ".rminute {padding:3px 2px 3px 2px; background:#B0B0B0; color:#FFFFFF; height:18px; float:left; cursor:pointer;}";
			css += "#rseconds {width:190px; height:200px;}";
			css += ".rsecond {padding:3px 2px 3px 2px; background:#B0B0B0; color:#FFFFFF; height:18px; float:left; cursor:pointer;}";
			...
			css += "#rcalendar {width:190px; height:190px; background:#FFFFFF; border:1px solid #999999; padding:4px; overflow:hidden; font-size:12px;}";
			css += "#rcalendar * {font-family:'微软雅黑';}";
			css += "#rcalendar_ym {width:190px; height:14px; overflow:hidden; margin-bottom:4px;}";
			...
			css += "#rhours {width:190px; height:108px;}";
			css += ".rhour {padding:3px 2px 3px 2px; background:#B0B0B0; color:#FFFFFF; height:18px;  float:left; cursor:pointer;}";
			css += "#rminutes {width:190px; height:190px;}";
			css += ".rminute {padding:3px 2px 3px 2px; background:#B0B0B0; color:#FFFFFF; height:18px; float:left; cursor:pointer;}";
			css += "#rseconds {width:190px; height:190px;}";
			css += ".rsecond {padding:3px 2px 3px 2px; background:#B0B0B0; color:#FFFFFF; height:18px; float:left; cursor:pointer;}";
...
function rselect_years(span_year) {
	if (ryears.style.display == "none") {
		...
		if (rc_browser.name == "Opera" || (rc_browser.name == "MSIE" && rc_browser.version == "8.0")) {
...
function rselect_hours(span_hour) {
	if (rhours.style.display == "none") {
		...
		rhours.style.top = (left_top[1] - parseInt(div_rcalendar.style.top) - 79) + "px";
		if (rc_browser.name == "Opera" || (rc_browser.name == "MSIE" && rc_browser.version == "8.0")) {
...
function rselect_minutes(span_minute) {
	if (rminutes.style.display == "none") {
		...
		rminutes.style.left = 10 + "px";
		rminutes.style.top = (left_top[1] - parseInt(div_rcalendar.style.top) - 145) + "px";
		if (rc_browser.name == "Opera" || (rc_browser.name == "MSIE" && rc_browser.version == "8.0")) {
...
function rselect_seconds(span_second) {
	if (rseconds.style.display == "none") {
		...
		rseconds.style.left = 10 + "px";
		rseconds.style.top = (left_top[1] - parseInt(div_rcalendar.style.top) - 145) + "px";
		if (rc_browser.name == "Opera" || (rc_browser.name == "MSIE" && rc_browser.version == "8.0")) {
