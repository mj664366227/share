...
<form action="<?php echo url('works','add');?>" method="post">
  ...
  <a href="<?php echo url('works','delete','id='.$cat['_id']);?>" title="点击删除“<?php echo $cat['name'];?>”" onclick="return confirm('删除作品类型有可能会影响到用户的数据！你确定要删除“<?php echo $cat['name'];?>”吗？')"><?php echo $cat['name'];?></a>
  <?php endforeach?>
  </td>
  </tr>
    <tr>
