...
<?php view::load_js('TweenMax.min');?>
<?php view::load_js('resizeable');?>
<?php view::load_js('joinable');?>
<?php view::load_js('xenon-api');?>
<?php view::load_js('xenon-toggles');?>
<?php view::load_js('xenon-widgets');?>
<?php view::load_js('toastr.min');?>
<?php view::load_js('globalize.min');?>
