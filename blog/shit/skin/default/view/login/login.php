  ...
  <div class="row">
	...
	$("form#login .form-group:has(.form-control):first .form-control").focus();
      ...
      <form method="post" role="form" id="login" class="login-form fade-in-effect">
        <div class="login-header"> <a href="dashboard-1.html" class="logo"> <img src="assets/images/logo@2x.png" alt="" width="80" /> <span>log in</span> </a>
        ...
        <div class="form-group">
          <button type="submit" class="btn btn-dark  btn-block text-left"> <i class="fa-lock"></i> Log In </button>
        </div>
      ...
      <!-- External login -->
      <div class="external-login"> <a href="#" class="facebook"> <i class="fa-facebook"></i> Facebook Login </a> 
