package com.exam.core.annotation.processor;
...
import com.exam.core.annotation.Menu;
import com.exam.core.util.Check;
...
public final class MenuProcessor extends AnnotationProcessor {
	 ...
	 * url => 菜单名 map
	 */
	private static HashMap<String, String> url2MenuMap = new HashMap<String, String>();
	...
	protected void resolve(Object object, Method method) {
		...
		synchronized (menuMap) {
			...
			url2MenuMap.put(requestMapping.value()[0], menu.menu().trim());
	 ...
	 * @author ruan 
	 */
	public HashMap<String, String> getUrl2MenuMap() {
		return url2MenuMap;
	}
}