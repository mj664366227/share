...
import com.exam.core.msgbody.company.AdminSendPointsMessageBody;
import com.exam.core.msgbody.company.CaseFinishMessageBody;
import com.exam.core.msgbody.company.FocusCaseMessageBody;
import com.exam.core.msgbody.company.IdeaPubMessageBody;
import com.exam.core.msgbody.company.UserFocusCompanyMessageBody;
import com.exam.core.msgbody.company.UserReplyCompanyMessageBody;
import com.exam.core.msgbody.user.CaseFinishBonusMessageBody;
import com.exam.core.msgbody.user.CaseNewMessageBody;
import com.exam.core.msgbody.user.CompanyReplyUserMessageBody;
import com.exam.core.msgbody.user.DelIdeaMessageBody;
import com.exam.core.msgbody.user.IdeaCommentPubMessageBody;
import com.exam.core.msgbody.user.IdeaCommentReplyMessageBody;
import com.exam.core.msgbody.user.IdeaPraiseUpMessageBody;
import com.exam.core.msgbody.user.MarketOpusCommentPubMessageBody;
import com.exam.core.msgbody.user.MarketOpusCommentReplyMessageBody;
import com.exam.core.msgbody.user.UserFocusMessageBody;
import com.exam.core.msgbody.user.UserInvitePubIdeaMessageBody;
