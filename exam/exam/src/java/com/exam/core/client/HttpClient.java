...
public final class HttpClient {
	...
	*/
	...
	public String post(String url) {
		return post(url, nullMap, nullMap);
	}
	...
	public String postNotUrlencode(String url) {
		return postNotUrlencode(url, nullMap, nullMap);
	}
	...
	public String postNotUrlencode(String url, Map<String, Object> data) {
		return postNotUrlencode(url, data, nullMap);
	}
